...
Compost allocates capital through three channels:
...
### 2. Partner Allocations (50-70% of vault)

Direct arrangements with HIP-3 deployers.

| Aspect | Detail |
|--------|--------|
| Fee share | Typically 20-40% of trading fees |
| Terms | Vary by partner and allocation size |
| Advantage | Compost's scale enables better terms than retail |

**Current Partners:** TBC

---

### 3. Direct Deployment (0% initially)
...
| Channel | % of Vault | Fee Share | Status |
|---------|------------|-----------|--------|
| Validator staking | 20-30% | ~2.5% APY | Active |
| Partner allocations | 50-70% | 20-40% | Active |
| Direct deployment | 0% | 50% | Phase 2+ |

---

## Selection Criteria

Before allocating to any partner, we assess:
...
| Unproven markets | Partner allocation only |
